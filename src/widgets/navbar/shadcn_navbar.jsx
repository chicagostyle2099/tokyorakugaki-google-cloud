...
import { Root, List, Item, Trigger, Content, Link, Indicator, Viewport } from "@radix-ui/react-navigation-menu";
...
const NavigationMenuViewport = React.forwardRef((props, ref) => (
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <Viewport
      ...
      ref={ref}
      {...props}
      style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }} // Adjust the opacity value (0.5)
    />
  </div>
));
